...
<div class="col-md-6 col-lg-6 my-auto">
    <div class="profile__agents-info">
        <h5 class="text-capitalize">
            <a href="#" target="_blank">Hannah</a>
        </h5>
        <p class="text-capitalize mb-1">property agent</p>

        <ul class="list-unstyled mt-2">
            <li><a href="#" class="text-capitalize"><span><i class="fa fa-building"></i> office :</span> 123 456
                    789</a>
            </li>
            <li><a href="#" class="text-capitalize"><span><i class="fa fa-phone"></i> mobile :</span> 123 456
                    789</a></li>
            <li><a href="#" class="text-capitalize"><span><i class="fa fa-fax"></i> fax : </span> 342 655</a></li>
    ...
    <div class="row no-gutters">
        <div class="col-md-4 col-lg-3 col-xl-4">
            <div class="card__image__header h-250">
                <a href="#">
                    <div class="ribbon text-capitalize" style="background-color:#11572E; color: #fff;">sold out</div>
        ...
        <div class="col-md-4 col-lg-6 col-xl-5 my-auto">
            <div class="card__image__body">
                ...
                <span class="badge badge-primary text-capitalize mb-2" style="background-color:#11572E; color: #fff;">house</span>
                <h6>
    ...
    <div class="products__filter__group">
        ...
        <div class="products__filter__footer">
            <div class="form-group mb-0">
                <button class="btn text-capitalize btn-block" style="background-color: #11572E; color: #fff;"> submit <i
