                            ...
                            <div class="col-12 col-lg-2 col-md-3">
                                <div class="form-group">
                                    <button class="btn  text-uppercase btn-block"
                                        style="background-color: #11572E; border-color: #11572E; color: #fff; border-radius: 5px; margin-left: 10px;">
                                                            ...
                                                            <div class="card__image__header h-250">
                                                                <a href="propertyDetail">
                                                                    <div class="ribbon text-capitalize"
                                                                        style="background-color: #11572E;">{{$listing->status}}</div>
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-md-4 col-lg-3 col-xl-4">
                                                            <div class="card__image__header h-250">
                                                                <a href="#">
                                                                    <div class="ribbon text-capitalize"
                                                                        style="background-color: #11572E;">sold out</div>
                                                        ...
                                                        <div class="col-md-4 col-lg-6 col-xl-5 my-auto">
                                                            <div class="card__image__body">
                                                                ...
                                                                <span class="badge badge-primary text-capitalize mb-2"
                                                                    style="background-color: #11572E;">house</span>
                                                                <h6>
                                                    ...
                                                    <a href="{{route('propertyDetail', $listing->slug->slug)}}">
                                                        <div class="card__image card__box-v1">
                                                            <div class="card__image-header h-250">
                                                                ...
                                                                <img src="images/apart4.jpg" alt=""
                                                                    class="img-fluid w100 img-transition">
                                                                <div class="info" style="background-color: #11572E;"> {{$listing->listing_for}}</div>
                                                            </div>
                                            ...
                                            <div class="col-md-4 col-lg-4">
                                                <div class="card__image card__box-v1">
                                                    <div class="card__image-header h-250">
                                                        ...
                                                        <img src="images/apart2.jpg" alt=""
                                                            class="img-fluid w100 img-transition">
                                                        <div class="info" style="background-color: #11572E;"> for sale
                                                        </div>
                                                    </div>
                                                    <div class="card__image-body">
                                                        <span class="badge badge-primary text-capitalize mb-2"
